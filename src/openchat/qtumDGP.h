#ifndef OPENNETWORKDGP_H
#define OPENNETWORKDGP_H
...
class OpennetworkDGP {
    
public:

    OpennetworkDGP(OpennetworkState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
