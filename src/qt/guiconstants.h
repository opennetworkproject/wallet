...
#define QAPP_ORG_NAME "Opennetwork"
#define QAPP_ORG_DOMAIN "opennetwork.org"
#define QAPP_APP_NAME_DEFAULT "Opennetwork-Qt"
#define QAPP_APP_NAME_TESTNET "Opennetwork-Qt-testnet"
