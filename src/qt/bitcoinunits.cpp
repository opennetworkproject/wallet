...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OPENNETWORK");
    case mBTC: return QString("mOPENNETWORK");
    case uBTC: return QString::fromUtf8("μOPENNETWORK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Opennetworks");
    case mBTC: return QString("Milli-Opennetworks (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Opennetworks (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
