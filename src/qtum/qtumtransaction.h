#ifndef OPENNETWORKTRANSACTION_H
#define OPENNETWORKTRANSACTION_H
...
class OpennetworkTransaction : public dev::eth::Transaction{

public:

    OpennetworkTransaction() : nVout(0) {}

    OpennetworkTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    OpennetworkTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
