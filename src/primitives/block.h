...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // opennetwork
        hashUTXORoot.SetNull(); // opennetwork
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //opennetwork
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //opennetwork
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //opennetwork
    {
