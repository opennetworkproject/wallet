...
/////////////////////////////////////////// opennetwork
#include <opennetwork/opennetworkstate.h>
#include <opennetwork/opennetworkDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <opennetwork/storageresults.h>
...
using ExtractOpennetworkTX = std::pair<std::vector<OpennetworkTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // opennetwork
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashOpennetworkRoot,
    const dev::h256& oldHashStateRoot, const std::vector<OpennetworkTransaction>& transactions);
...
class OpennetworkTxConverter{

public:

    OpennetworkTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionOpennetworkTransactions(ExtractOpennetworkTX& opennetworkTx);
...
private:
    ...
    OpennetworkTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<OpennetworkTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
