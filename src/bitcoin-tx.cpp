...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s opennetwork-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  opennetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded opennetwork transaction") + "\n" +
              "  opennetwork-tx [options] -create [commands]   " + _("Create hex-encoded opennetwork transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    static const unsigned int maxVout = dgpMaxBlockSize / minTxOutSz; // opennetwork
